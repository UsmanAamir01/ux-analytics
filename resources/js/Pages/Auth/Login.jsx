    ...
    <div className="min-h-screen bg-slate-100 px-4 py-8 text-slate-900 sm:px-6 lg:px-8">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-6xl items-center justify-center">
        <div className="grid w-full overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-2xl shadow-slate-300/60 lg:grid-cols-2">
              ...
              <div>
                ...
                <div className="max-w-md">
                  ...
                  <h2 className="text-5xl font-bold leading-tight tracking-tight">
                    Understand every click, scroll, and session.
                  </h2>

                  <p className="mt-6 text-base leading-7 text-slate-300">
                    Watch session replays, identify friction points, and improve
                    your product experience with clear behavioral analytics.
                  </p>
                </div>
              </div>

              <div className="grid grid-cols-3 gap-4">
                <Stat value="500+" label="Free sessions" />
                <Stat value="rrweb" label="Replay engine" />
          ...
          {/* Right Side */}
          <div className="relative flex min-h-[680px] items-center justify-center overflow-hidden p-6 sm:p-10">
            ...
            <div className="relative w-full max-w-md">
              <div className="mb-8 text-center">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Sign in to access your UX Analytics dashboard.
                </p>
              </div>
